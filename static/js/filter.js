(function() {
    ...
    filterToggleSearchInput.addEventListener("click", (event) => {
    ...
    filterToggleCategoryInput.addEventListener("click", (event) => {
    ...
    filterCategoryCheckboxes[0].form.addEventListener("reset", (event) => {
        setCategoryFilters([]);
        closeCategoryMenu();
    });
